  ...
  return (
    <div className="grid grid-cols-3">
      ...
      <div className="flex items-center justify-center">
          ...
          <button className="text-center justify-center items-center flex mt-12 mx-auto">
          ...
          <span class="uppercase">proceed to payment</span>
            <svg className="w-6 h-6 inline-block ml-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z" /></svg>
          </div>
          </button>
      </div>
        </div>
